...
| velociraptor_admin_password | defaults/main.yml | `vault_velociraptor_admin_password` | Referenced Vaulted Variable that sets the Admin Password for the WebGui |
...
* If using a reverse-proxy like nginx, set plain http options. <https://velociraptor.velocidex.com/velociraptor-network-communications-30568624043a>
